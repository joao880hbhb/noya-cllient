    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center">
          <router-link to="/" class="flex items-center gap-2 text-xl sm:text-2xl font-bold text-[#5B4BFF]">
            <svg class="h-7 w-7" viewBox="0 0 24 24" fill="currentColor">
              <path d="M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1zm1 3v2h8V7H6zm0 4v2h12v-2H6zm0 4v2h9v-2H6z" />
            </svg>
            MyNoya
          </router-link>
        </div>
        ...
        <div class="flex items-center gap-3 sm:gap-4">
                ...
                <div v-else-if="notifications.length" class="max-h-96 overflow-y-auto">
                  ...
                  >
                    ...
                    <div class="min-w-0">
                      ...
                      <p class="text-[11px] text-gray-400 mt-1">{{ formatRelativeTime(notification.createdAt) }}</p>
                    </div>
                    <span
            ...
            <div class="relative">
              ...
              >
                <img
                  ...
                  alt="Profile"
                  class="h-10 w-10 rounded-full object-cover ring-2 ring-gray-100 hover:ring-[#5B4BFF] transition"
                />
                <div
                  v-else
                  class="h-10 w-10 rounded-full bg-[#5B4BFF] flex items-center justify-center text-white text-sm font-bold ring-2 ring-gray-100 hover:ring-[#5B4BFF] transition"
                >
              ...
              >
                <div class="px-4 py-3 border-b border-gray-100">
                  <p class="text-sm font-semibold text-gray-900 truncate">{{ authStore.userDisplayName }}</p>
          ...
          <template v-else>
            <router-link
              to="/login"
              class="inline-flex items-center gap-2 px-5 py-2 bg-[#5B4BFF] text-white text-sm font-medium rounded-full hover:bg-[#4a3dcc]"
            >
              Masuk
            </router-link>
          </template>
