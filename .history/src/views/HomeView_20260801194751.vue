  ...
  <div class="min-h-screen bg-white">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-6 flex items-end justify-between">
        ...
        <router-link
          to="/blogs"
          class="hidden sm:inline-flex items-center text-sm font-medium text-gray-600 hover:text-gray-700"
        >
          View all &rarr;
        </router-link>
      </div>
              ...
              <div class="group flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <span
                    ...
                    class="mt-2 inline-flex items-center gap-1 rounded-full bg-[#20b356]/10 px-2 py-0.5 text-[11px] font-medium text-[#20b356]"
                  >
                    <svg
                      class="h-3 w-3"
                      fill="currentColor"
