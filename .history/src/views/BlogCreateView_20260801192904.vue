            ...
            >
              ...
              <div>
                <input
                  ...
                  v-model="tagsInput"
                  type="text"
                  class="w-full text-[14px] text-[#111111] placeholder-[#C9C9C9] border-0 border-b border-[#E7E7E7] focus:border-[#111111] focus:ring-0 p-3 pb-2 bg-transparent transition-colors"
