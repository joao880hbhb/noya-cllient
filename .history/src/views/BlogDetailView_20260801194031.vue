      ...
      >
        ...
        >
          ...
          <div class="flex-1">
            ...
            <p v-if="blog.music.album" class="text-sm opacity-80">
              {{ blog.music.album }}
            </p>
        ...
        <div class="p-6 sm:p-10">
          ...
          <!-- Meta -->
          <div
            class="mt-4 flex items-center justify-between border-b border-gray-200 pb-6"
          >
            <router-link
          ...
          <!-- Excerpt -->
          <p v-if="blog.excerpt" class="mt-6 text-lg text-gray-600 italic">
            {{ blog.excerpt }}
          </p>
