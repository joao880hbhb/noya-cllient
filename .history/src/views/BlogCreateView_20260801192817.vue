      ...
      <form @submit.prevent="handleSubmit">
        ...
        >
          ...
          <div class="md:pl-6">
            ...
            >
              ...
              <div>
                <input
                  ...
                  class="w-full pl-5 text-[22px] font-display text-[#111111] placeholder-[#C9C9C9] border-0 border-b border-[#E7E7E7] focus:border-[#111111] focus:ring-0 px-0 pb-2 bg-transparent transition-colors"
            ...
            <!-- Music -->
            <div
              class="grid md:grid-cols-[140px_1fr] gap-x-8 px-6 sm:px-10 py-8"
            >
              <label
                class="text-[11px] tracking-[0.15em] text-[#8A8A8A] uppercase pt-1"
              >
